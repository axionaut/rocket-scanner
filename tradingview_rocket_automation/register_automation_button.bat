...
setlocal
set "ROOT=%~dp0"
set "LAUNCHER=%ROOT%rocket_scanner_launcher.vbs"
...
reg add "HKCU\Software\Classes\rocket-scanner\shell\open\command" /ve /d "\"%SystemRoot%\System32\wscript.exe\" //B //Nologo \"%LAUNCHER%\" \"%%1\"" /f >nul
